...
const MobileCarousel = dynamic(() => import("@/subcomponents/MobileCarousel"), {
  ssr: false,
});
...
const Hero = () => {
  ...
  const TextContainer = isMobile ? "div" : motion.div;
  const textContainerProps = isMobile
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[70%_30%] gap-1 w-full md:pr-1">
        ...
        <TextContainer {...textContainerProps}>
          <div className="px-6 pt-6 pb-4">
            {/* Heading */}
            {isMobile ? (
              <h1 className="text-4xl sm:text-5xl font-medium text-left text-white uppercase md:leading-20 leading-normal mt-4 tracking-tight">
            ...
            {/* Paragraph */}
            {isMobile ? (
              <p className="text-sm sm:text-base font-light text-left text-gray-300 pb-6 max-w-2xl">
          ...
          {/* Marquee */}
          {isMobile ? (
            <div className="bg-black p-1 rounded-md my-2 font-roboto-mono mt-2 mb-6">
          ...
          {/* Deco */}
          {isMobile ? (
            <div className="md:hidden bottom-20 my-5">
              <Deco />
            </div>
          ) : (
            <>
        ...
        {isMobile ? (
          ...
          >
            <DesktopCarousel items={projects} />
          </motion.div>
        )}
      </div>
